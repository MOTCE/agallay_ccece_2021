...
object MultistageInterconnectionNetwork_FIFO_param extends App {
  ...
  chiselStage.emitVerilog(
    new MultistageInterconnectionNetwork_FIFO_param(DEFAULT_N_PORT, DEFAULT_INPUT_W, Array[Int](8, 4, 2)),
